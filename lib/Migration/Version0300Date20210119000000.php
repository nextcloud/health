	...
	* @return null|ISchemaWrapper
	...
	private function expandPersons(ISchemaWrapper $schema) {
		try {
			...
			$table->addColumn('shared', Type::TEXT, [
				'notnull' => false,
				'default' => null,
			]);
			$table->addColumn('shared_readonly', Type::TEXT, [
				'notnull' => false,
				'default' => null,
			]);
	...
	private function expandWeightdata(ISchemaWrapper $schema) {
		try {
			...
			$table->addColumn('waist_size', Type::FLOAT, [
				'notnull' => false,
				'default' => null,
			]);
			$table->addColumn('hip_size', Type::FLOAT, [
				'notnull' => false,
				'default' => null,
			]);
			$table->addColumn('muscle_part', Type::FLOAT, [
				'notnull' => false,
				'default' => null,
			]);
	...
	private function createFeelingData(ISchemaWrapper $schema) {
		if (!$schema->hasTable('health_feelingdata')) {
			...
			$table->addColumn('symptoms', Type::TEXT, [
				'notnull' => false,
				'default' => null,
			]);
			$table->addColumn('attacks', Type::TEXT, [
				'notnull' => false,
				'default' => null,
			]);
			$table->addColumn('medication', Type::TEXT, [
				'notnull' => false,
				'default' => null,
			]);
