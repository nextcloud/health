...
class GoalTargetRegistry {
	...
	private const TARGETS = [
		...
		'kilocalories' => ['targetKey' => 'kilocalories', 'metricKey' => 'kilocalories', 'category' => 'measurement', 'periods' => ['day', 'week', 'month'], 'comparators' => ['gte', 'lte'], 'kind' => 'period_value', 'unit' => 'kcal', 'minimum' => 0.000001],
