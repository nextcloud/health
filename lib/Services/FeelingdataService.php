...
class FeelingdataService {
	...
	public function __construct($userId, FeelingdataMapper $fdM, FormatHelperService $fhS, PermissionService $permissionService) {
		$this->userId = $userId;
		$this->feelingdataMapper = $fdM;
	...
	public function getLastFeeling($personId) {
		// TODO
		if( !$this->permissionService->personData($personId, $this->userId)) {
			return null;
		}
