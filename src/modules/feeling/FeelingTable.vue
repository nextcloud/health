		...
		headerDefinition() {
			return [
				...
				},
				{
					...
					options: [
						{ id: 0, label: 'No pain' },
						{ id: 1, label: 'Very Mild' },
						{ id: 2, label: 'Discomforting' },
						{ id: 3, label: 'Tolerable' },
						{ id: 4, label: 'Distressing' },
						{ id: 5, label: 'Very Distressing' },
						{ id: 6, label: 'Intense' },
						{ id: 7, label: 'Very intense' },
						{ id: 8, label: 'Utterly Horrible' },
						{ id: 9, label: 'Excruciating' },
						{ id: 10, label: 'Unimaginable' },
					],
				},
				{
					...
					options: [
						{ id: 0, label: 'Bedridden' },
						{ id: 1, label: 'Very low' },
						{ id: 2, label: 'Low' },
						{ id: 3, label: 'Somewhat low' },
						{ id: 4, label: 'Below normal' },
						{ id: 5, label: 'Normal' },
						{ id: 6, label: 'Above normal' },
						{ id: 7, label: 'Somewhat high' },
						{ id: 8, label: 'High' },
						{ id: 9, label: 'Very high' },
						{ id: 10, label: 'Indescribable' },
					],
				},
				{
