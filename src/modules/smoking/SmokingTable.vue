	...
	computed: {
		headerDefinition() {
			return [
				...
				{
					name: t('health', 'Desire level'),
					columnId: 'desireLevel',
					type: 'select',
					options: [
						{ id: 0, label: t('health', 'nothing') },
						{ id: 1, label: t('health', 'a little') },
						{ id: 2, label: t('health', 'okay') },
						{ id: 3, label: t('health', 'more') },
						{ id: 4, label: t('health', 'high') },
						{ id: 5, label: t('health', 'very high') },
