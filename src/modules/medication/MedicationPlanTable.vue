...
export default {
	...
	methods: {
		addItem(item) {
			...
			this.$store.dispatch('medicationPlanDatasetsAppend', item)
		},
		updateItem(item) {
			// console.debug('update item', item)
			this.$store.dispatch('medicationPlanDatasetsUpdate', item)
		},
		deleteItem(item) {
			// console.debug('delete item', item)
			this.$store.dispatch('medicationPlanDatasetsDelete', item)
		},
		selectItem(item) {
			this.$store.dispatch('medicationPlanSelected', item)
		},
	},
}
</script>
