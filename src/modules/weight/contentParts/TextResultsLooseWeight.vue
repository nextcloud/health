...
<template>
	<div>
		...
		<p v-if="weight > target && weight <= initialWeight">
			{{ t('health', 'You lost already {diff}{unit} and you have {toGo}{unit} to go.', transValues) }}
			<br>
			<br>
...
export default {
	...
	computed: {
		...
		getProgressbarValue() {
			...
			const wantToLoose = this.initialWeight - this.target
